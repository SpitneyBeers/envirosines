...
function toggleMode() {
    ...
    const displayNames = { 'drone': 'Drone', 'pulse': 'Pulse', 'chord': 'Chord' };
    const colors = { 'drone': '#a50', 'pulse': '#0a5', 'chord': '#50a' };
...
function toggleWaveform() {
    const waveforms = ['sine', 'triangle', 'sawtooth', 'roundpm', 'cello', 'organ', 'oboe', 'tympani'];
